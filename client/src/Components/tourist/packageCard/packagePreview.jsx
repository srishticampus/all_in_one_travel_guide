...
export const PackagePreview = () => {
  ...
  const getPackages = async () => {
    try {
      ...
      if (res.status === 200) {
        ...
        setFilterdPacks(data.slice(0, 0));
      }
    } catch (error) {
  ...
  return (
    <div id="pack-card-container tw-mt-5">
      <h3 className="tw-text-center tw-mt-3"> Latest Packages </h3>
      ...
      {filterdPacks.length === 0 && (
        <div className="tw-flex tw-h-96 tw-justify-center tw-items-center">
          ...
          <img alt="coming-soon" src="https://cdni.iconscout.com/illustration/premium/thumb/coming-soon-illustration-download-in-svg-png-gif-file-formats--opening-digital-marketing-shop-board-people-activities-pack-illustrations-7973903.png?f=webp" />
        </div>
      )}
