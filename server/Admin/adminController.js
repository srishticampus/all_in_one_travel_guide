...
const searchTouristPlaceByLoc = (req, res) => {
  tourists
    .find({
      loc: { $regex: ".*" + req.body.loc + ".*", $options: "i" },
      isactive: true,
    })
    .exec()
    .then((data) => {
...
module.exports = {
  addPlace,
  viewTouristPlaceById,
  viewAllPlaces,
  editTouristPlaceById,
  deleteTouristplaceById,
  searchTouristPlaceByDistrict,
  searchTouristPlaceByDistrictAndCity,
  searchTouristPlaceByLoc,
  upload,
  approveTouristPlaceById,
  viewAllPlacesforApproval,
  viewAllApprovedPlaces,
};
